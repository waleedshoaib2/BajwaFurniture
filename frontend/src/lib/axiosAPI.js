...
export const adminGetOrder = async (userInfo, id) => {
  ...
  return await axios.get(`http://localhost:4000/api/orders/${id}`, config);
};
...
export const adminUpdateOrder = async (userInfo, isDelivered, id) => {
  ...
  return await axios.put(
    `http://localhost:4000/api/orders/${id}/deliver`,
    body,
    config
  );
};
...
export const adminGetOrders = async (userInfo, pageNumber) => {
  ...
  return await axios.get(
    `http://localhost:4000/api/orders?pageNumber=${pageNumber}`,
    config
  );
};
